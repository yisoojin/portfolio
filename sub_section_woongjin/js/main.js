...
$(document).ready(function(){
    ...
    function pc(){
        ...
        /*article h4을 click 할때 너비와 높이가 변함*/
        $("article h4").on("click", function(e){

            e.preventDefault();//a태그 자체 이벤트 방지

            //선택한 article h4는 on class 추가
            $(this).addClass("on");
            
            //선택하지않은article 다른 on class가 지워짐(remove)
        ...
        /*변한 article에서 .close_btn를 click하면 on class가 remove */
        $("article .close_btn").on("click", function(){
