...
async function init() {
  ...
  const gltf = await gltfLoader.loadAsync('./src/models/ferrari_f40/scene.gltf');
  ...
  directionalLight1.position.y = 8;
  ...
  //그림자를 받을 object
  const geometry = new THREE.PlaneGeometry( 2.5, 5, 24, 24 );
  ...
  controls.minDistance = 4; //줌의 최소거리

  controls.maxDistance = 8; //줌의 최대거리
